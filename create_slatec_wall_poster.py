#!/usr/bin/env python3
"""Create a wall poster-friendly markdown file of SLATEC functions."""
...
def create_wall_poster():
    ...
    content = []
    content.append("# SLATEC Function Library Reference")
    content.append("")
    content.append("*Complete alphabetical listing of all 690 SLATEC mathematical functions*")
    content.append("")
    content.append("---")
    content.append("")
    ...
    # Write to file
    with open('SLATEC_FUNCTION_WALL_POSTER.md', 'w') as f:
        f.write('\n'.join(content))
    
    print(f"Created SLATEC_FUNCTION_WALL_POSTER.md with {total} functions")
    
    # Also create a more detailed single-column version for reference
    content2 = []
    content2.append("# SLATEC Function Library - Detailed Reference")
    content2.append("")
    content2.append("*Complete alphabetical listing with full descriptions*")
    content2.append("")
    ...
    with open('SLATEC_FUNCTION_DETAILED_REFERENCE.md', 'w') as f:
        f.write('\n'.join(content2))
    
    print(f"Also created SLATEC_FUNCTION_DETAILED_REFERENCE.md for detailed reference")
